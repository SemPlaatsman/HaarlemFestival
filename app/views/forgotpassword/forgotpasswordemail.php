...
<body>
	...
	<p>-------------------------------------------------------------</p>
	<p><a href="<?php echo $baseUrl ?>/resetpassword?key=<?php echo $key ?>&email=<?php echo $email ?>&action=reset" target="_blank">
	<?php echo $baseUrl ?>/resetpassword?key=<?php echo $key ?>&email=<?php echo $email ?>&action=reset</a></p>
	<p>-------------------------------------------------------------</p>
