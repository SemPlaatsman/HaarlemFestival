...
<body class="container-fluid">
  ...
  <div class="row bg-tetiare-a mx-auto">
    <div class="col-sm-12  col-md-6 prices  p-5 order-1 order-lg-0">
      ...
      <input type="submit" data-bs-toggle="modal" data-bs-target="#historyTicketForm" class="btn btn-primary btn-block insert-button-venue bg-primary-a border-primary-a rounded-0 buyButton" value="BUY TICKETS ">
    </div>
