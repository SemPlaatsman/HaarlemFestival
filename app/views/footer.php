...
<footer class="bg-primary-a footer mt-auto">
  <section class="container p-1 row mx-auto d-flex align-items-center">
    ...
    <form class="col-md-6 d-flex align-items-center h-75" action="" id="newsletterForm">
      <input class="footer-input border border-3 border-dark fs-5 w-75" type="email" name="email"
        placeholder="tourist@haarlem.nl">
      <button class="footer-input footer-title fs-2 bg-dark text-primary-a border-0" type="submit"
        form="newsletterForm">SIGN UP</button>
    </form>
  </section>
</footer>
