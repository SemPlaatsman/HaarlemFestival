...
<div class="container-fluid bg-black">
    <div class="position-relative">
        <img src="img/png/dance/detail/Hardwell-banner.png" class="img-fluid w-100 h-100" alt="Banner Image">
    ...
    <div class="section-with-background-1">
        <div class="row">
            <div class="col-md-4 offset-md-1">
                <h2 class="text-center text-light-purple mt-5 m1-1 display-3">WHO IS HARDWELL?</h2>
                <?php foreach ($model['pages'] as $page) { ?>
                    <?php if ($page->getId() === 29) { ?>
            ...
            <div class="col-4">
                <img src="img/png/dance/detail/Group-Hardwell.png" class="w-100"></img>
            </div>
        </div>
        <div class="row">
            <img src="img/png/dance/detail/Group-Hardwell-2.png" class="col-md-5"></img>
            <div class="col-md-4 offset-md-2">
                <h2 class="text-center justify-content-center text-light-purple mt-5 display-3">HIGHLIGHTS</h2>
                <?php foreach ($model['pages'] as $page) { ?>
                    <?php if ($page->getId() === 30) { ?>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="img/png/dance/detail/Group-Hardwell-3.png" class="w-100"></img>
            </div>
        </div>

        <h1 class="text-center text-light-purple mt-5 display-2">TAKE A LISTEN</h1>
        <div class="align-items-center text-center">
            <img src="img/png/dance/detail/Simulated-Music-1.png" class="col-md-3"></img>
            <img src="img/png/dance/detail/Simulated-Music-2.png" class="col-md-3"></img>
        </div>
    </div>
    <?php
